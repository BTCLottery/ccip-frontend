...
export default function CCIPBridgeFeeTokens({ccipFees, feeTokens, openFeeTokenModal, selectedFeeSymbol, setOpenFeeTokenModal, setSelectedFeeToken, setSelectedFeeSymbol}: ICCIPBridgeFeeTokens) {
  ...
  return (
    <section ref={modalRef}>
        <div className="flex justify-between mt-4 text-lg">
            <div className='flex justify-center items-center text-gray-200'>Fee</div>
            ...
            <div className="flex flex-row justify-center items-center">
                ...
                <div className='bg-primaryPurpleBgDarker rounded-l-lg py-1 px-2'>
                    <CCIPNetworkFeeTokenIcon logoKey={selectedFeeSymbol} widthSize={24} heightSize={24} />
                </div>
        ...
        <div className={`w-full mx-auto flex-end`}>
            <div className='absolute flex justify-end w-full max-w-[400px] h-auto rounded-lg'>
                {openFeeTokenModal && feeTokens && Object.entries(feeTokens).map(([key, value]) => {
                    ...
                    className="flex flex-row justify-start items-center h-auto bg-primaryPurpleBgDarker hover:bg-primaryPurpleBgDarkest p-3">
                        <CCIPNetworkFeeTokenIcon logoKey={key} widthSize={21} heightSize={21} />
